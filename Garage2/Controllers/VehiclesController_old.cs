...
//{
//    public class VehiclesController_old : Controller
//    {
...
//                    break;
//                case "type_desc":
//                    vehicle = vehicle.OrderByDescending(v => v.TypeVehicle.VType);
//                    break;
//                case "type_asc":
//                    vehicle = vehicle.OrderBy(v => v.TypeVehicle.VType);
//                    break;
//                case "brand_desc":
//                    vehicle = vehicle.OrderByDescending(v => v.TypeVehicle.Brand);
//                    break;
//                case "brand_asc":
//                    vehicle = vehicle.OrderBy(v => v.TypeVehicle.Brand);
//                    break;
...
//                vehicle.ParkNr = AddToFirstEmptySpace(vehicle.TypeVehicle.VType); // fixa parkeringsnummer
