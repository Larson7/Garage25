...
{
    public class VehiclesController_fail : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "VehicleId,MemberId,RegNr,Color,CheckInTime,ParkNr")] Vehicle vehicle)
        {
            if (ModelState.IsValid)
            {
